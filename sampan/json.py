...
from sysdev.tools.common.sampan.exception import JSONError

"""
    Json tools for format, encode and decode, inspired by simplejson <https://simplejson.readthedocs.io>.
