...
def serve():
    ...
    if cmd_args.bind:
        ...
        print('Sampan web bind: {}:{}'.format(_addr, _port))

    if cmd_args.server:
        print('Sampan web server: {}'.format(cmd_args.server))

    if cmd_args.plugin:
        print('Sampan web plugins: {}'.format(cmd_args.plugin))

    if cmd_args.conf:
        print('Sampan web conf: {}'.format(cmd_args.conf))

    if cmd_args.args:
        print('Sampan web extra args: {}'.format(cmd_args.args))
